...
/** Test cases for the {@link MultiKafkaCDCToBigQuery} class. */
public class MultiKafkaCDCToBigQueryTest {
  ...
  /** Tests the {@link MultiKafkaCDCToBigQuery} pipeline end-to-end. */
  @Test
  public void testMultiKafkaCDCToBigQueryE2E() throws Exception {
    // Test input
    ...
    MultiKafkaCDCToBigQuery.Options options =
            PipelineOptionsFactory.create().as(MultiKafkaCDCToBigQuery.Options.class);
    ...
    PAssert.that(transformOut.get(MultiKafkaCDCToBigQuery.TRANSFORM_DEADLETTER_OUT)).empty();
    PAssert.that(transformOut.get(MultiKafkaCDCToBigQuery.TRANSFORM_OUT))
            .satisfies(
                    collection -> {
    ...
    PAssert.that(badTransformOut.get(MultiKafkaCDCToBigQuery.TRANSFORM_DEADLETTER_OUT)).empty();
    PAssert.that(badTransformOut.get(MultiKafkaCDCToBigQuery.TRANSFORM_OUT)).empty();

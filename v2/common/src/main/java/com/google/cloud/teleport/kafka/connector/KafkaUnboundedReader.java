...
class KafkaUnboundedReader<K, V> extends UnboundedReader<KafkaRecord<K, V>> {
  ...
  public boolean start() throws IOException {
    ...
    Object groupId = spec.getConsumerConfig().get("dev-multikafka-cdc-odoo-bq-20210222-01");
  ...
  public Instant getWatermark() {
    ...
    return new Instant(curRecord.getTimestamp());
  }
  ...
  private void nextConsumerBatch() throws IOException {
    curConsumerBatch = Collections.emptyIterator();
